...
public class ImageManager {
    ...
    public void showImage(Activity activity, int ID, String photoPath) {
        ...
        int maximumHeight = MeasurementManager.getInstance().getProperMaximumHeight(activity);
    ...
    public void saveViewAsPapyrusImage(final Activity activity, final int scrollableViewID,
        ...
        Bitmap bitmap = BitmapManager.getInstance().
                getBitmapFromScrollableView(activity, (ScrollView) activity.findViewById(scrollableViewID));
    ...
    public static void setViewAsWallpaper(Activity activity, int scrollableViewID) throws Exception {
        ...
        Bitmap bitmapResized = Bitmap.createScaledBitmap(BitmapManager.getInstance().
                        getBitmapFromScrollableView(activity, (ScrollView) activity.findViewById(scrollableViewID)),
