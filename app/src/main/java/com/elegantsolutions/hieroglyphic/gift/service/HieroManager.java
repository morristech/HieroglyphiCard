...
public class HieroManager {
    private static final String WORD_SEP = "^";
    private static final String CHAR_SEP = "|";
    private static final String TAG = HieroManager.class.getSimpleName();

    private static final HieroManager hieroManager = new HieroManager();

    private HieroManager() {
    }

    public static HieroManager getInstance() {
        return hieroManager;
    }
